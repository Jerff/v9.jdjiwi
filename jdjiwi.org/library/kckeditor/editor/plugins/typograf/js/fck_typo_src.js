...
function typo_text()
{
	...
	{
		//alert(oEditor.FCKConfig.PluginsPath + 'typograf/typo_offline.php');
		//alert(variable);
		$.post(oEditor.FCKConfig.PluginsPath + 'typograf/php/typo_offline.php', {text : variable}, show_typo);
	}
	//typograf 2
	...
	textOut.innerHTML = '<table width="100%" height="100%" border="0"><tr><td valign="center"><img src="'+oEditor.FCKConfig.PluginsPath+'typograf/loader.gif"></td></tr></table>';
