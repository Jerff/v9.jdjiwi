...
$info = cRegister::sql()->placeholder("SELECT id, view, parent, name, content, title, keywords, description FROM ?t WHERE isUri=? AND isVisible='yes'", db_content_info, $infoUri)
								->fetchAssoc();
if(!$info) return 404;
$infoId = $info['id'];
